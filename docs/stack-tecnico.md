...
**Audio**: sfx y música CC0 (Kenney Audio, FreePD); voces según GDD §7 (grabadas en casa o TTS provisional). Formato: OGG Vorbis. Las voces provisionales de personaje se generan con **Qwen3-TTS en fal.ai** (`herramientas/generar_voces_fal.py`, una voz fija por personaje en `herramientas/voces_personajes/<id>/`, ver decisión del 14-Sep-2026); las líneas de personajes sin voz elegida siguen con `herramientas/generar_voces_tts.ps1` (TTS de Windows).
