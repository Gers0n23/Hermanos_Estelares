# Perfil de los jugadores — sesión de descubrimiento (HE-D1)

Entrevistas hechas por el papá (Product Owner) a cada hijo. Este documento es fuente de verdad
para personalizar personajes, planetas, minijuegos y celebraciones (Fase 0 del tablero).

**Referencia visual oficial**: [`assets/hermanosestelares.jpeg`](../assets/hermanosestelares.jpeg) —
los tres hermanos como astronautas exploradores (Maxi con traje blanco/azul, Nicole y Sofía con
trajes rosados), estrellas brillantes, planetas y cometas. Así imagina el papá la aventura.

---

## Maxi (2 años) — nivel semilla

**Entrevista: 18-Jul-2026**

- **Personalidad**: muy despierto, bueno para bailar, actitud muy valiente.
- **Animales favoritos**: dinosaurios — le encantan el tiranosaurio rex, el spinosaurio y el carnotauro.
- **Personajes / historias que ama hoy**: Sonic, Toy Story, la película Cars y todo lo que tenga
  que ver con autos; también Tayo el autobús y Blippi.
- **Apps / juegos que ya usa**: apps tipo memory (tarjetas que se van dando vuelta), juegos de
  autos, y apps educativas como Lingokids.
- **Qué lo asusta o aburre**: nada lo asusta realmente; se aburre con películas demasiado largas
  o historias donde hablan mucho.
- **Gesto de celebración real**: grita «¡¡siiii!!» y da unos 3 saltitos con el puño derecho arriba.
- **Sueños / mundos que le fascinan**: quiere ser bombero; le fascinan los dinosaurios, los
  animales, los autos, Sonic, el espacio.

**Implicaciones de diseño**:

- Minijuegos con acción directa e inmediata, narración breve — poca charla, mucho tocar.
- Memory de tarjetas es mecánica ya conocida y amada: candidata segura para su nivel semilla.
- Dinosaurios y autos como temas de sus variantes de contenido (p. ej. tarjetas de dinosaurios).
- Su celebración en el juego puede imitar su gesto real: salto con puño arriba + «¡siiii!»
  (coincide con su pose en la imagen de referencia).
- La música y el baile conectan con él: celebraciones bailables.
